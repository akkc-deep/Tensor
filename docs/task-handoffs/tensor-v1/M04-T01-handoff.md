...
- `docs/task-handoffs/tensor-v1/M04-T01-handoff.md`: 刷新为本次 Docker Hub 环境阻塞快照。
- `docs/task-handoffs/tensor-v1/tensor-v1-task-board.md`: 本次将同步记录 `IN_PROGRESS -> BLOCKED` 与解阻条件。
...
1. `docs/task-handoffs/tensor-v1/tensor-v1-task-board.md`
2. `docs/task-designs/M04-T01-design.md`
3. `docs/task-handoffs/tensor-v1/M04-T01-handoff.md`
