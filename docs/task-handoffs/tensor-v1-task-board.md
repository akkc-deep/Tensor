...
| 28 | M05-T01 | `PluginRegistry` 与 `AdapterRegistry` | `IN_PROGRESS` | M02-T05 | docs/task-designs/M05-T01-design.md | docs/task-handoffs/M05-T01-handoff.md |
