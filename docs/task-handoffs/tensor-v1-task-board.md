...
| 45 | M08-T03 | fixture 注册→适配→入库→查询集成测试 | `READY` | M05-T01, M05-T05, M06-T04, M06-T06, M08-T02 | docs/task-designs/M08-T03-design.md | docs/task-handoffs/M08-T03-handoff.md |
