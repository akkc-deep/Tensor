...
2026-09-06用户要求把剩余工作转交新任务，现由 [M14-T09](../../task-designs/M14-T09-design.md) 承接，见 [transfer交接](../../task-handoffs/tensor-v1/M14-T09-handoff.md)。业务保存规则仍待确认，此移交不批准候选四字段方案；旧诊断已完成且不可复用。
