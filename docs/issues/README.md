...
| ISSUE-003 | 数据库交互逻辑较复杂 | Spring JDBC 收敛方案已确认，待实施计划 | [详情](problems/ISSUE-003-database-access-complexity.md) · [方案](proposals/ISSUE-003-spring-jdbc-complexity-reduction.md) |
