...
| ISSUE-007 | dividend 业务键未区分实施进度 | 已移交M14-T09，业务键/迁移设计待确认 | [诊断详情](problems/ISSUE-007-dividend-adapter-diagnosis.md) · [修复设计](proposals/ISSUE-007-dividend-business-key.md) |
