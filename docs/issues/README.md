...
| ISSUE-018 | 补齐按日期区间批量下载能力 | 处理中 | T01–T05 已完成；T06 设计与交接就绪、READY，策略、任务执行与真实完整性验收待后续任务 | [详情](problems/ISSUE-018-date-range-batch-downloads.md) · [方案草稿](proposals/ISSUE-018-date-range-batch-downloads.md) · [详细设计](../task-designs/ISSUE-018-design.md) · [任务看板](../task-handoffs/ISSUE-018/ISSUE-018-task-board.md) |
