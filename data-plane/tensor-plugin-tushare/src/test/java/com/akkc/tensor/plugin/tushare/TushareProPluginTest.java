...
class TushareProPluginTest {
    ...
    @Test
    void rejectsRetiredApisBeforeCallingUpstream() {
        ...
        for (String apiName : List.of("top_inst", "broker_recommend", "share_float", "hs_const",
                "moneyflow_hsgt", "hk_hold", "index_member", "hsgt_top10", "namechange")) {
            assertThatThrownBy(() -> plugin.download(ApiName.of(apiName), Map.of()))
                    .isInstanceOf(IllegalArgumentException.class)
