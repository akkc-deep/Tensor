...
public final class PaginationConstants {
    ...
    public static final String FIRST_PAGE_TEXT = StringConstants.EMPTY + FIRST_PAGE;
    public static final String DEFAULT_TASK_PAGE_SIZE_TEXT = StringConstants.EMPTY + DEFAULT_TASK_PAGE_SIZE;
