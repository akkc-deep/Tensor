...
/** @typedef {'PARAM_REQUIRED'|'PARAM_INVALID'|'PLUGIN_DISABLED'|'DATASET_MISCONFIGURED'|'SOURCE_AUTH_FAILED'|'SOURCE_PERMISSION_DENIED'|'SOURCE_RATE_LIMITED'|'SOURCE_UNAVAILABLE'|'SOURCE_NETWORK_ERROR'|'SOURCE_TIMEOUT'|'SOURCE_PAYLOAD_INVALID'|'ADAPTER_FIELD_MISSING'|'ADAPTER_TYPE_INVALID'|'PERSISTENCE_FAILED'|'QUERY_FAILED'|'INTERNAL_ERROR'|'TASK_NOT_FOUND'|'SUBMISSION_CONFLICT'|'TASK_STATE_CONFLICT'|'TASK_DEFINITION_CHANGED'|'BATCH_DOWNLOAD_UNAVAILABLE'|'TASK_QUEUE_FULL'|'BATCH_COMPLETENESS_UNCONFIRMED'|'SOURCE_RANGE_MISMATCH'|'TASK_LIMIT_EXCEEDED'|'EXECUTION_INTERRUPTED'|'INTEGRITY_UNAVAILABLE'|'INTEGRITY_DEFINITION_CHANGED'|'INTEGRITY_CHECK_NOT_FOUND'|'INTEGRITY_QUEUE_FULL'|'INTEGRITY_LIMIT_EXCEEDED'} ApiErrorCode */
...
const API_RULES = Object.freeze({
  ...
  SUBMISSION_CONFLICT: [409, false],
  TASK_STATE_CONFLICT: [409, false],
  TASK_DEFINITION_CHANGED: [409, false],
  BATCH_DOWNLOAD_UNAVAILABLE: [409, false],
  TASK_QUEUE_FULL: [429, true],
  BATCH_COMPLETENESS_UNCONFIRMED: [409, false],
  SOURCE_RANGE_MISMATCH: [502, false],
  TASK_LIMIT_EXCEEDED: [409, false],
  EXECUTION_INTERRUPTED: [409, false],
  INTEGRITY_UNAVAILABLE: [409, false],
  INTEGRITY_DEFINITION_CHANGED: [409, false],
  INTEGRITY_CHECK_NOT_FOUND: [404, false],
  INTEGRITY_QUEUE_FULL: [429, true],
  INTEGRITY_LIMIT_EXCEEDED: [400, false],
})
